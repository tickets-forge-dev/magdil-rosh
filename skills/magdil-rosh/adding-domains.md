...
6. Keep project-specific rows inline where relevant (multiple backends, regulated-data logging rules, locales, design-system-first) under a "Project-specific (adapt)" heading.
